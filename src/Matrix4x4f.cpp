...
bool inverse(const Matrix4x4f& m, Matrix4x4f& result) {
    ...
    inv[0] = m.values[5]  * m.values[10] * m.values[15] - 
    ...
    inv[4] = -m.values[4]  * m.values[10] * m.values[15] + 
    ...
    inv[8] = m.values[4]  * m.values[9] * m.values[15] - 
    ...
    inv[12] = -m.values[4]  * m.values[9] * m.values[14] + 
    ...
    inv[1] = -m.values[1]  * m.values[10] * m.values[15] + 
    ...
    inv[5] = m.values[0]  * m.values[10] * m.values[15] - 
    ...
    inv[9] = -m.values[0]  * m.values[9] * m.values[15] + 
    ...
    inv[13] = m.values[0]  * m.values[9] * m.values[14] - 
    ...
    inv[2] = m.values[1]  * m.values[6] * m.values[15] - 
    ...
    inv[6] = -m.values[0]  * m.values[6] * m.values[15] + 
    ...
    inv[10] = m.values[0]  * m.values[5] * m.values[15] - 
    ...
    inv[14] = -m.values[0]  * m.values[5] * m.values[14] + 
    ...
    inv[3] = -m.values[1] * m.values[6] * m.values[11] + 
    ...
    inv[7] = m.values[0] * m.values[6] * m.values[11] - 
    ...
    inv[11] = -m.values[0] * m.values[5] * m.values[11] + 
    ...
    inv[15] = m.values[0] * m.values[5] * m.values[10] - 
